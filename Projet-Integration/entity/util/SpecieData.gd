...
var SpecieAttributes:Dictionary[Species, Callable] = {
	...
	Species.SPECIE_2: func(att) : 
		...
		att.meat_efficiency = 1.6
		att.fruit_efficiency = 0.6,
	Species.SPECIE_3: func(att) : 
		...
		att.litter_size = 2
		att.meat_efficiency = 1.4,
	Species.SPECIE_4: func(att) : 
		att.speed = 0.8
		att.morale = 2
		att.food_chain = 6
		att.fightscore = 4
		att.meat_efficiency = 1.2
		att.stamina = 50,
	Species.SPECIE_5: func(att) : 
		...
		att.food_chain = 2
		att.fightscore = 7
		att.breeding_cooldown = 1.3
		att.litter_size = 2
		att.hunger_rate = 1.6
		att.meat_efficiency = 0.8
		att.fruit_efficiency = 1.5,
	Species.SPECIE_6: func(att) : 
		...
		att.meat_efficiency = 0.5
		att.fruit_efficiency = 1.6,
