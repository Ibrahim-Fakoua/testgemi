...
public partial class ActionShelf : TabContainer
{
	...
	[Export] public ButtonGroup BrushModeButtons;
	...
	private void ToggleButtonsOff()
	{
		...
		BaseButton button2 = BrushModeButtons.GetPressedButton();
		if (ActionButtons != null && button2 != null)
		{
			button2.SetPressedNoSignal(false);
		}
	}
